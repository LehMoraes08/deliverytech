...
/**
 * Handler global para capturar e tratar exceções lançadas na aplicação.
 * Centraliza a lógica de tratamento de erros, garantindo respostas padronizadas.
*/
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationExceptions(MethodArgumentNotValidException ex, WebRequest request) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(
            ...
            "Erro de validação",
            "Campos invalidos na requisição",
     ...
     * Isso garante que a API nunca exponha detalhes internos ao cliente.
     */
